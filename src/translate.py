...
# Import Google Cloud Translation and Text-to-Speech libraries
...
#
# Sound files are saved to the ANKI_MEDIA_FOLDER. A sound filename prefix is specified
...
# default Anki media folder can be overridden with -m <media_folder> command option
ANKI_MEDIA_FOLDER = '/home/charlie/.local/share/Anki2/Charlie/collection.media'

def translate_text(texts, outfile, romanize, soundfile_folder, soundfile_prefix, soundfile_index):
